...
from base import base_connect_database, base_log, base_ipv4
...
with base_connect_database.engine_conn('postgre') as conn:
    df = pd.read_sql("ods_info_incr_adata_etf_base", con=conn.engine)
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run(app, host="192.168.254.1", port=1024)  # host=ipv4 address, you can cmd and ifconfig find it 
    ipv4 = base_ipv4.ipv4_address()
    print(f'ipv4: {ipv4}')
