...
@author: awei
最高价卖出价格模型(train_2_reg_price_high)
建议
...
if __name__ == '__main__':
    ...
    asset_df = asset_df[~((asset_df.next_high_rate.apply(np.isinf))|(asset_df.next_low_rate.apply(np.isinf)))]
    ...
    # output
    valid_df = pd.merge(valid_raw_df, asset_df[['primary_key','next_high_rate','next_low_rate','price_limit_rate','open','high','low',
