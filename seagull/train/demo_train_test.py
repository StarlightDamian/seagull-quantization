...
from seagull.utils import utils_database, utils_character, utils_log

def dataset_1(subtable):
    subtable[['prev_close']] = subtable[['close']].shift(1)
    subtable[['high_pct', 'low_pct', 'open_pct', 'close_pct','avg_price_pct']] = subtable[['high', 'low', 'open', 'close','avg_price']].div(subtable['prev_close'], axis=0)
    subtable[['next_high_pct', 'next_low_pct', 'next_close_pct']] = subtable[['high_pct', 'low_pct', 'close_pct']].shift(-1)
...
# =============================================================================
    ...
    df[['high_pct', 'low_pct', 'open_pct', 'close_pct','avg_price_pct']] = df[['high', 'low', 'open', 'close','avg_price']].div(df['prev_close'], axis=0)
