...
@author: awei
demo_train_lightgbm_reg_max_dd2
...
# =============================================================================
    ...
    X_train = X#.iloc[train_index], X.iloc[test_index]
    y_train  = y#.iloc[train_index], y.iloc[test_index]
...
# =============================================================================
    ...
    y_val_pred = y_val_pred.reset_index(drop=True)
    columns=['full_code','close','next_low_rate','next_high_rate','next_close_rate']
    y_val_pred[columns] = raw_df.loc[raw_df.date>'2024-12-03', columns].reset_index(drop=True)
    
    y_val_pred['y_10d_high_rate'] = y_val.y_10d_high_rate.values
    y_val_pred['y_10d_vwap_rate'] = y_val.y_10d_vwap_rate.values
    y_val_pred.loc[y_val_pred['y_10d_high_rate'] > y_val_pred['y_10d_vwap_rate_pred'],['trade']] = 1
    y_val_pred.loc[y_val_pred['y_10d_high_rate'] <= y_val_pred['y_10d_vwap_rate_pred'],['trade']] = 0
    ...
    y_val_pred.to_csv(f'{PATH}/_file/test_10d_high_rate.csv', index=False)
    
    #rmse_values = y_val.apply(lambda col: rmse(col, y_val_pred[col.name]))
    #print(rmse_values)
    # rmse(y_val.next_high_rate, y_val_pred[:,0])
    
    # result_reg.loc[result_reg.y_pred>1.05,'y_real'].prod()
# =============================================================================
#     rmse_values
#     Out[24]: 
#     next_high_rate     0.023893
#     next_low_rate      0.018153
#     next_close_rate    0.026888
#     y_10d_vwap_rate    0.070068
#     y_10d_max_dd       0.058422
#     y_10d_high_rate    0.117220
#     y_10d_low_rate     0.046748
#     dtype: float64
# =============================================================================
# =============================================================================
