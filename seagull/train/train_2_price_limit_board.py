...
@author: awei
训练涨跌停分类模型(train_2_price_limit_board)
"""
import argparse
import pandas as pd
...
class trainPriceLimitBoard(train_1_lightgbm_classification.lightgbmClassificationTrain):
    def __init__(self):
        super().__init__()
...
if __name__ == '__main__':
    ...
    train_price_limit_board = trainPriceLimitBoard()
    history_day_df = train_price_limit_board.board_data(history_day_df)
    prediction_df = train_price_limit_board.train_board_pipline(history_day_df)