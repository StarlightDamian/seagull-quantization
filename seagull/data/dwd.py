...
class dwdData():
    ...
    def dwd_freq_full_portfolio_daily_backtest(self):
        ...
        utils_data.output_database(portfolio_daily_backtest_df, filename='dwd_freq_full_portfolio_daily_backtest', index=True)
    ...
    def dwd_freq_incr_portfolio_daily(self):
        ...
        portfolio_daily_df['primary_key'] = (portfolio_daily_df['time'].astype(str) +
                                             ...
                                             ).apply(utils_character.md5_str) # md5（时间、带后缀代码、频率）
        utils_data.output_database(portfolio_daily_df, 'dwd_freq_incr_portfolio_daily')
