...
@Description: 北交所日频数据(ods/ohlc/stock_incr_efinance_cycle)
@Update cycle: day
...
if __name__ == '__main__':
    ...
    parser.add_argument('--stock_list', type=list, default=['sh', 'sz', 'bj', 'portfolio'], help='stock list')
    ...
    if args.update_type == 'full':
        ods_efinance_stock_bj_api.stock_daily(date_start=args.date_start, date_end=date_end)
        #ods_efinance_stock_bj_api.stock_minute(date_start=args.date_start, date_end=date_end)
