...
@Description: 获取所有场内ETF当前信息(ods/info/fund_full_adata)
@Update cycle: day
...
class OdsInfoFundSnapAdata(FundInfo):
    ...
    def all_etf_exchange_traded_info_east(self, wait_time=None):
        ...
        curr_page = 1
        data = []
        while curr_page < 20:  # 一页80，最大1169个基金
...
if __name__ == '__main__':
    ods_info_fund_full_adata = OdsInfoFundSnapAdata()
    ods_info_fund_full_adata.pipeline()
