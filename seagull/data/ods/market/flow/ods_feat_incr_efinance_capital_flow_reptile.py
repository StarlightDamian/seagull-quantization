# -*- coding: utf-8 -*-
"""
Created on Mon Jan 13 12:15:46 2025

@author: awei
获取所有场内ETF当前信息(ods_feat_incr_efinance_capital_flow_reptile)
优先个股，其次ETF
"""
...
from efinance.common.config import MARKET_NUMBER_DICT, MarketType
from efinance.shared import BASE_INFO_CACHE, session, MAX_CONNECTIONS
from efinance.utils import get_quote_id, to_numeric
from efinance.common.config import (EASTMONEY_BASE_INFO_FIELDS, EASTMONEY_HISTORY_BILL_FIELDS,
...
if __name__ == '__main__':
    ...
    #df = get_history_bill(code='000005')
    #print(df)
    code = '516010'
    fields = list(EASTMONEY_HISTORY_BILL_FIELDS.keys())
    columns = list(EASTMONEY_HISTORY_BILL_FIELDS.values())
