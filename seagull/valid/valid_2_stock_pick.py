...
TARGET_PRED_NAMES = ['rear_low_pct_pred', 'rear_high_pct_pred']
TARGET_REAL_NAMES = ['rear_low_pct_real', 'rear_high_pct_real']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--date_end', type=str, default='2021-01-01', help='End time for testing')
    ...
    history_day_df = valid_stock_pick.board_data(history_day_df)
    valid_stock_pick.valid_board_pipline(history_day_df)
