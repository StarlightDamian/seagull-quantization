...
def _apply_data_distribution_day(substring_pd):
    ...
    #substring_pd.reset_index().to_feather(f'{PATH}/_file/day/{year}_{month}_{day}.feather')
    substring_pd.reset_index().to_feather(f'{PATH}/_file/day/{year_month_day}.feather')
...
if __name__ == '__main__':
    data_day_all = pd.read_feather(f'{PATH}/_file/k_day_19901219_20230808.feather')
